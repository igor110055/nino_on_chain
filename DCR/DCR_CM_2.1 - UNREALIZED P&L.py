...
plt.plot(df['date'], df['P/L Depletion'])
plt.fill_between(df['date'], df['P/L Depletion'], where=df['P/L Depletion'] > 0, facecolor='blue', alpha=0.25)
plt.fill_between(df['date'], df['P/L Depletion'], where=df['P/L Depletion'] < 0, facecolor='red', alpha=0.25)
plt.title("Unrealized P/L Depletion Ratio")
